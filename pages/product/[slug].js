...
const  slug = (props)=> {
    const [data,setData] = useState(props.jdata);
    
  return (
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-5/12 w-full lg:h-auto h-64 object-cover object-center rounded border" src={data.thumbnail}/>
...
export async function getServerSideProps(context){
    ...
    let data = await fetch(`https://dummyjson.com/products/${slug}`);
